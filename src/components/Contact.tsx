          ...
          <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="group">
                ...
                <input type="text" id="name" name="name" placeholder="山田 太郎" className="w-full px-5 py-3.5 rounded-xl bg-white border border-zinc-200 text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:border-[#a8305f]/60 focus:ring-1 focus:ring-[#a8305f]/30 transition-all" />
              </div>
              <div className="group">
                ...
                <input type="email" id="email" name="email" placeholder="taro@example.com" className="w-full px-5 py-3.5 rounded-xl bg-white border border-zinc-200 text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:border-[#a8305f]/60 focus:ring-1 focus:ring-[#a8305f]/30 transition-all" />
              </div>
            </div>
            <div className="group">
              ...
              <select id="type" name="type" className="w-full px-5 py-3.5 rounded-xl bg-white border border-zinc-200 text-zinc-500 focus:text-zinc-900 focus:outline-none focus:border-[#a8305f]/60 focus:ring-1 focus:ring-[#a8305f]/30 transition-all appearance-none">
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.4 }} className="mt-8 flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            {[
              ...
              <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" className="group w-12 h-12 rounded-full bg-black/[0.03] border border-black/[0.06] flex items-center justify-center text-zinc-500 hover:text-zinc-900 hover:border-black/[0.12] transition-all hover:scale-110" aria-label={s.label}>
